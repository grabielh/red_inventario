<div class="space-y-6">
    ...
    <div>
        ...
        <x-text-input id="name" name="name" type="text" class="mt-1 block w-full data-input" value="All in One" autocomplete="name" placeholder="Name" oninput="updateCounter('name')" readonly />
